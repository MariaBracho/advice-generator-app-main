...
const render = () => {
    ...
    <div class="w-full h-screen bg-Dark_Blue flex justify-center items-center relative z-10 ">
     ...
     <img alt="divider" class="mb-7 mx-auto " src="${isMobile? mobile:desktop}">


     </div>

     <div class="w-full absolute -bottom-6 mx-auto  ">
     <button class="h-16 w-16  bg-Neon_Green rounded-full border-none outline-none cursor-pointer hover:drop-shadow-3xl " id="button"><img alt="icon" class="mx-auto" src="${iconDice}"></button>
     </div>
